import { hasInjectionContext, getCurrentInstance as getCurrentInstance$1, version as version$1, unref, inject as inject$1, readonly, toRaw, isRef, isReactive, toRef, createVNode, mergeProps, Transition, toRefs, shallowRef, ref, computed, watch, nextTick, watchEffect, provide, onScopeDispose, withDirectives, vShow, Fragment, resolveDirective, reactive, capitalize, h, defineComponent as defineComponent$1, camelize, TransitionGroup, Text, resolveDynamicComponent, effectScope, warn, Teleport, cloneVNode, createTextVNode, vModelText, useSSRContext, createApp, getCurrentScope, onErrorCaptured, onServerPrefetch, shallowReactive, isReadonly, markRaw, defineAsyncComponent, isShallow, withCtx, Suspense } from 'vue';
import { u as useRuntimeConfig$1, o as withQuery, p as hasProtocol, q as parseURL, t as isScriptProtocol, l as joinURL, c as createError$1, $ as $fetch$1, v as sanitizeStatusCode, x as createHooks, y as defu, z as appendHeader, A as getRequestHeaders, B as sendRedirect } from '../nitro/node-server.mjs';
...
function useRequestHeaders(include) {
  var _a2;
  const event = (_a2 = (/* @__PURE__ */ useNuxtApp()).ssrContext) == null ? void 0 : _a2.event;
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/course-e92b7fa1.mjs').then((m) => m.default || m)
  },
  {
    name: "admin",
    path: "/admin",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-68a08a26.mjs').then((m) => m.default || m)
  },
  {
    name: "admin-inscription-idCourse",
    path: "/admin/inscription/:idCourse()",
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_idCourse_-99cdab04.mjs').then((m) => m.default || m)
  },
  {
    name: "admin-services",
    path: "/admin/services",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/services-0f0e276a.mjs').then((m) => m.default || m)
  },
  {
    name: "admin-teachers",
    path: "/admin/teachers",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/teachers-774969c9.mjs').then((m) => m.default || m)
  },
  {
    name: "admin-users",
    path: "/admin/users",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/users-f65836b6.mjs').then((m) => m.default || m)
  },
  {
    name: "assistant-course",
    path: "/assistant/course",
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/course-e7197eb4.mjs').then((m) => m.default || m)
  },
  {
    name: "assistant",
    path: "/assistant",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-abeabcae.mjs').then((m) => m.default || m)
  },
  {
    name: "assistant-inscription-idCourse",
    path: "/assistant/inscription/:idCourse()",
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_idCourse_-c0284c11.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-ab277ec4.mjs').then((m) => m.default || m)
  },
  {
    name: "recovery",
    path: "/recovery",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/recovery-715722fc.mjs').then((m) => m.default || m)
  }
];
...
const chartjs_1wC9lAM0Tp = /* @__PURE__ */ defineNuxtPlugin(() => {
...
const layouts = {
  default: () => import('./_nuxt/default-1a9cf0d1.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-404-fd4426d3.mjs').then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-500-741b847c.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-027472f1.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
export { VForm as V, _export_sfc as _, useAuth as a, useNuxtApp as b, createError as c, defineStore as d, entry$1 as default, useRequestFetch as e, useTheme as f, injectHead as i, navigateTo as n, resolveUnrefHeadInput as r, storeToRefs as s, useRouter$1 as u };
